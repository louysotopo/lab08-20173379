...
<% User mio = (User)request.getAttribute("AccessObj"); %>  
...
<li><a href="/users/delete?Id=<%= mio.getId() %>">Borrar</a></li>

</ul>
<% String fec = mio.getFecha(); boolean sta = mio.getStatus(); String namRol = mio.getNameRole(); String Correo = mio.getEmail();  %>
...
<form action=" " method="get"   class="sign-up">
    ...
    <label>Correo<input class="sign-up-input" type="text"  name="name" value ="<%=Correo%>"  readonly="readonly" ></label><br>
